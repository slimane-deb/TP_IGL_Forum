...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
    	<div class="header">
        	<p href="<?php echo $url_home; ?>"><img src="<?php echo $design; ?>/images/logo.png" alt="Espace Membre" /></p>
	    </div>
        <div class="content">
<?php
...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">GeekList</a> &gt; Liste des utilisateurs
    </div>
	<div class="box_right">
    	<input type="text" /><a href="list_pm.php">Vos messages(<?php echo $nb_new_pm; ?>)</a> - <a href="profile.php?id=<?php echo $_SESSION['userid']; ?>"><?php echo htmlentities($_SESSION['username'], ENT_QUOTES, 'UTF-8'); ?></a> (<a href="login.php">Déconnexion</a>)
    </div>
    <div class="clean"></div>
</div>
<?php
