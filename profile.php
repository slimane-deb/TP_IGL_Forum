...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
    	<div class="header">
        	<p href="<?php echo $url_home; ?>"><img src="<?php echo $design; ?>/images/logo1.png" alt="Espace Membre" /></p>
	    </div>
        <div class="content">
<?php
...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Index du Forum</a>  <a href="users.php">Liste des utilisateurs</a>  Profil d'un utilisateur</a>
    </div>
	<div class="box_right">
...
?>
		...
		<div class="foot"><a href="http://www.supportduweb.com/scripts_tutoriaux-code-source-89-simple-php-forum-script-forum-en-php-facile-simple-script-code-telecharger-forum-php-gratuit-mysql.html">Acceder au monde</a>  <a href="http://www.supportduweb.com/">GeekALL</a></div>
	</body>
</html>